      ...
      <div className="flex flex-col overflow-hidden">
        <div className="flex justify-center z-20 mt-4 mb-2">
          <Image
            ...
            width={150}
            height={150}
            src="https://res.cloudinary.com/dkxtgziy2/image/upload/v1719401829/important/WhatsApp_Image_2024-05-29_at_15.02.21_7ef0bb41_edynej.jpg"
            alt=""
          />
        </div>
        <div className="mx-auto inline-flex justify-center hover:cursor-pointer z-20">
          <Link
            href={"/misc/Resume_Mohammed_Amjad_Ali.pdf"}
            target="_blank"
          ...
          >
            ...
            >
              ...
              <span className="dark:text-white text-black dark:cursor-pointer font-serif text-xl">
                {" "}
                Resume
              </span>
            </Button>
