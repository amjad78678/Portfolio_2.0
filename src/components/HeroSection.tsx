...
const HeroSection = () => {
  ...
  return (
    <div
    className='h-auto md:h-[45rem] w-full rouded-md flex flex-col justify-center items-center relative overflow-hidden mx-auto py-10 md:py:0'
    >
 <Spotlight
...
<div className="flex justify-center my-6 space-x-6">
            <Link href={"https://www.facebook.com/profile.php?id=100024613400275&mibextid=ZbWKwL"}
              target="_blank"
  rel="noopener noreferrer"
            ...
            <Link href={"https://www.instagram.com/amjadali.omr?igsh=NTRqcXV1dDNzd21t"}
                target="_blank"
    rel="noopener noreferrer"
            className="cursor-pointer text-gray-400 hover:text-gray-300">
            ...
            <Link href={"http://www.linkedin.com/in/mohammed-amjad-ali-mk-brohreftype"}
                target="_blank"
    rel="noopener noreferrer"
